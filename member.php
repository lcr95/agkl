...
<body class="container-fluid">
	...
	<div class="container-fluid" style="margin-top:100px;">
		...
		<tr>
		<th>Address: </th><td>B6-4-3, Evergreen Condominium, Kajang, Selangor</td>
		</tr>
		<tr>
		<th>MOLpoint: </th><td>RM52.00</td>
		</tr>
		</table>
		</div>
	</div>
	...
	<div id="order">
		<button onclick="location.href = 'order.php';" id="myButton" class="float-left submit-button" style="height:35px;width:130px;" >
